...
class Info_contract_warranty_between_date_range extends MY_Controller {
    ...
    public function index() {
    	...
    	$data_send = array(
            'page_title' => ci_trans('info_warranty_between_date_range_'),
    ...
    public function get_contract_warranty_between_date_range() {
    	$this->load->model(array('contract_warranty_detail_model', 'contract_list_model'));
        ...
        $result_get_contract_id
        	= $this->contract_warranty_detail_model
        		->get_contract_id_warranty_between_date_range();
    ...
    public function get_info_data() {
    	$this->load->model(array('contract_list_model', 'contract_warranty_detail_model'));
    	...
    	$result_contract_warranty_detail 
    		= $this->contract_warranty_detail_model
    			->get_contract_warranty_detail_and_status_by_contract_id($id);

    	$data_return = array(
    		'contract' => $result_contract,
    		'contract_warranty_detail' => $result_contract_warranty_detail
		);
