                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="inquiry-table" class="table">
                            <tbody>
                                <tr>
                                    <td align="right"><label><?php echo ci_trans('ma_start_date_'); ?></label></td>
                                    <td class="td-date">
                                        <div class="col-xs-12 col-no-padding">
                                            <div class="input-group date dtpicker">
                                                <input type="text" class="form-control" id="maintenance_date_start" 
                                    ...
                                    <td align="right"><label><?php echo ci_trans('ma_end_date_'); ?></label></td>
                                    <td class="td-date">
                                        <div class="col-xs-12 col-no-padding">
                                            <div class="input-group date dtpicker">
                                                <input type="text" class="form-control" id="maintenance_date_end" 
                                ...
                                <tr>
                                    <td align="right"><label><?php  echo ci_trans('Contract maintenance status'); ?></label></td>
                                    <td colspan="3">
                                        <select name="contract_maintenance_detail_status_id" class="form-control">
                                            ...
                                            <?php  
                                                foreach($contract_maintenance_detail_status as $cwds) {
        ...
        <?php $this->load->view('layouts/contract_list/info_contract_maintenance_between_date_range/modal_maintenance_detail'); ?>
