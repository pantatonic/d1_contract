        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>
                    ...
                    <small><?php echo ci_trans('Contract payment period status subtitle'); ?></small>
                </h1>
            </section>
        ...
        <?php $this->load->view('layouts/contract_list/contract_payment_period_status/modal_contract_payment_period_status_edit'); ?>