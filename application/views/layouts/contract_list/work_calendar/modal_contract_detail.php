    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <?php echo $common_element->get_save_loading_button(); ?>
            </div>
        </div>
    </div>
</div>

<div id="modal-maintenance-detail" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                    ...
                    <div class="force-min-width">
                        ...
                        <span id="maintenance-text"></span> <?php echo ci_trans('number_time_'); ?>
                        &nbsp;&nbsp;&nbsp;
                        <label><?php echo ci_trans('every_period_'); ?> :</label>
                        <span id="maintenance-range-text"></span>
                        &nbsp;&nbsp;&nbsp;
                        <label><?php echo ci_trans('in_ma_range_'); ?> :</label>
                        <span id="maintenance-total-month-text"></span>
                    </div>
                    <hr>
                    <table id="table-maintenance-detail" class="table table-hover table-striped force-min-width">
                        <thead>
                            <tr>
                                <th colspan="4"><?php echo ci_trans('Maintenance detail'); ?></th>
                            </tr>
                        </thead>
                        <tbody>     
