                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="inquiry-table" class="table">
                            <tbody>
                                <tr>
                                    <td align="right"><label><?php echo ci_trans('warranty_start_date_'); ?></label></td>
                                    <td class="td-date">
                                        <div class="col-xs-12 col-no-padding">
                                            <div class="input-group date dtpicker">
                                                <input type="text" class="form-control" id="warranty_date_start" 
                                                    name="warranty_date_start" 
                                    ...
                                    <td align="right"><label><?php echo ci_trans('warranty_end_date_'); ?></label></td>
                                    <td class="td-date">
                                        <div class="col-xs-12 col-no-padding">
                                            <div class="input-group date dtpicker">
                                                <input type="text" class="form-control" id="warranty_date_end" 
                                                    name="warranty_date_end" 
                                ...
                                <tr>
                                    <td align="right"><label><?php  echo ci_trans('Contract warranty status'); ?></label></td>
                                    <td colspan="3">
        ...
        <?php $this->load->view('layouts/contract_list/info_contract_warranty_between_date_range/modal_warranty_detail'); ?>
