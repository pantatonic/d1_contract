	...
	return {
		get_list: function() {
			jQuery('#list-table').dataTable({
		        ...
		        bFilter: true,
		        ajax: {
		            url: 'contract_list_status/get_contract_list_status_list',
		            type: 'get'
		        },
		        columns: [
		            {data: 'status'}
	...
	return {
		...
		get_data: function(id) {
			...
			setTimeout(function() {
				jQuery.ajax({
					type: 'get',
					url: 'contract_list_status/get_contract_list_status_by_id',
					cache: false,
					data: {
						id: id
					},
		...
		save: function() {
			...
			setTimeout(function() {
				if(result_simple_validate) {
					...
					jQuery.ajax({
						type: 'post',
						url: 'contract_list_status/save_contract_list_status',
						data: form_data,
						cache: false,
						beforeSend: function() {},
						success: function(response) {
